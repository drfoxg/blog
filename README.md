...
Но даже если у нас будет процессор на 128 ядер и больше 40 Гб только под одни воркеры PHP-FPM, заниматься ожиданием ответа от бота внутри запроса, это антипаттерн.  
